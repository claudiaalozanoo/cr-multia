...
sft_config = SFTConfig(
    output_dir="/ijc/LABS/SOLE/DATA/tfm_CLG/relation_extraction/FINETUNNING/RESULTS_LLAMA_v6",
...
# save adapter
OUT_DIR_LLM = "/ijc/LABS/SOLE/DATA/tfm_CLG/relation_extraction/FINETUNNING/RESULTS_LLAMA_v6"
...
# save results
output_path = Path("/ijc/LABS/SOLE/DATA/tfm_CLG/relation_extraction/FINETUNNING/RESULTS_LLAMA_v6")
output_path.mkdir(parents=True, exist_ok=True)

with open(output_path / "llama_results.json", "w", encoding="utf-8") as f:
    json.dump(results, f, indent=4, ensure_ascii=False)

with open(output_path / "report_LLAMA_FINETUNNED_v6.txt", "w") as f:
