...
EJEMPLOS:
- Para la frase : "Es [exitus] (bdhiue65) el 12 de abril de 2008 por [sepsis] (7e3gjus)" -> [{"from_id": "bdhiue65", "to_id": "7e3gjus", "type": "caused_by"}]
- Para la frase : "Es tracta amb [LENA] (fwiebgu4) al 2008 y es para per [malaltia estable] (843bdi4)" -> [{"from_id": "fwiebgu4", "to_id": "843bdi4", "type": "has_outcome"}] 
"""
...
sft_config = SFTConfig(
    output_dir="/ijc/LABS/SOLE/DATA/tfm_CLG/relation_extraction/FINETUNNING/RESULTS_QWEN_v4",
...
# save adapter
OUT_DIR_LLM = "/ijc/LABS/SOLE/DATA/tfm_CLG/relation_extraction/FINETUNNING/RESULTS_QWEN_v4"
...
# save results
output_path = Path("/ijc/LABS/SOLE/DATA/tfm_CLG/relation_extraction/FINETUNNING/RESULTS_QWEN_v4")
output_path.mkdir(parents=True, exist_ok=True)

with open(output_path / "qwen_results.json", "w", encoding="utf-8") as f:
    json.dump(results, f, indent=4, ensure_ascii=False)

with open(output_path / "report_QWEN_FINETUNNED_v4.txt", "w") as f:
