...
sft_config = SFTConfig(
    output_dir="cr-multia/relation_extraction/FINETUNNING/RESULTS_QWEN_v2",
...
# save adapter
OUT_DIR_LLM = "cr-multia/relation_extraction/FINETUNNING/RESULTS_QWEN_v2"
...
# save results
output_path = Path("cr-multia/relation_extraction/FINETUNNING/RESULTS_QWEN_v2")
