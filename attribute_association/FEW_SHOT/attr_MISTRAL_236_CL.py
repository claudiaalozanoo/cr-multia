...
with open("/ijc/LABS/SOLE/DATA/tfm_CLG/attribute_association/PLAIN/mistral_results_236.json", "w", encoding="utf-8") as f:
...
with open("/ijc/LABS/SOLE/DATA/tfm_CLG/attribute_association/PLAIN/report_MISTRAL_236.txt", "w") as f:
    f.write("Attribute Classification Report\n")
    f.write(report)

print("Report saved to report_MISTRAL_236.txt")
