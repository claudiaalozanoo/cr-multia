...
with open("cr-multia/attribute_association/FEW_SHOT/mistral_results_236.json", "w", encoding="utf-8") as f:
...
with open("cr-multia/attribute_association/FEW_SHOT/report_MISTRAL_236.txt", "w") as f:
