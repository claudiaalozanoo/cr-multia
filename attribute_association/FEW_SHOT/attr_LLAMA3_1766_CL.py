...
with open("/ijc/LABS/SOLE/DATA/tfm_CLG/attribute_association/PLAIN/llama3_results_1766.json", "w", encoding="utf-8") as f:
...
with open("/ijc/LABS/SOLE/DATA/tfm_CLG/attribute_association/PLAIN/report_LLAMA3_1766.txt", "w") as f:
