...
with open("cr-multia/attribute_association/FEW_SHOT/phi_results_236.json", "w", encoding="utf-8") as f:
...
with open("cr-multia/attribute_association/FEW_SHOT/report_PHI_236.txt", "w") as f:
