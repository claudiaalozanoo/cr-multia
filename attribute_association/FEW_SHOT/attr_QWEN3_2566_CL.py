...
with open("cr-multia/attribute_association/FEW_SHOT/qwen3_results_2566.json", "w", encoding="utf-8") as f:
...
with open("cr-multia/attribute_association/FEW_SHOT/report_QWEN3_2566.txt", "w") as f:
