...
def generate_mistral_prompt(task):
...
with open("/ijc/LABS/SOLE/DATA/tfm_CLG/attribute_association/PLAIN/mistral_results_1766.json", "w", encoding="utf-8") as f:
    json.dump(results, f, ensure_ascii=False, indent=4)
    
print("Results saved to mistral_results_1766.json")
...
with open("/ijc/LABS/SOLE/DATA/tfm_CLG/attribute_association/PLAIN/report_MISTRAL_1766.txt", "w") as f:
    f.write("Attribute Classification Report\n")
    f.write(report)

print("Report saved to report_MISTRAL_1766.txt")
