...
with open("/ijc/LABS/SOLE/DATA/tfm_CLG/attribute_association/PLAIN/gemma_results_2566.json", "w", encoding="utf-8") as f:
    json.dump(results, f, ensure_ascii=False, indent=4)
    
print("Results saved to gemma_results_2566.json")
...
with open("/ijc/LABS/SOLE/DATA/tfm_CLG/attribute_association/PLAIN/report_GEMMA_2566.txt", "w") as f:
    f.write("Attribute Classification Report\n")
    f.write(report)

print("Report saved to report_GEMMA_2566.txt")
