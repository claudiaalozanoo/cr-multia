...
for task in tqdm_cli(valid_tasks):
    ...
    raw_response = '{"attribute": "' + raw_gen
...
with open("/ijc/LABS/SOLE/DATA/tfm_CLG/attribute_association/PLAIN/qwen3_results_118.json", "w", encoding="utf-8") as f:
    json.dump(results, f, ensure_ascii=False, indent=4)
    
print("Results saved to qwen3_results_118.json")
...
with open("/ijc/LABS/SOLE/DATA/tfm_CLG/attribute_association/PLAIN/report_QWEN3_118.txt", "w") as f:
    f.write("Attribute Classification Report\n")
    f.write(report)

print("Report saved to report_QWEN3_118.txt")
