...
with open("/ijc/LABS/SOLE/DATA/tfm_CLG/attribute_association/PLAIN/deepseek_results_520.json", "w", encoding="utf-8") as f:
    json.dump(results, f, ensure_ascii=False, indent=4)
    
print("Results saved to deepseek_results_520.json")
...
with open("/ijc/LABS/SOLE/DATA/tfm_CLG/attribute_association/PLAIN/report_DEEPSEEK_520.txt", "w") as f:
    f.write("Attribute Classification Report\n")
    f.write(report)

print("Report saved to report_DEEPSEEK_520.txt")
