...
def generate_gemma_prompt(task):
...
for task in tqdm_cli(valid_tasks):
    user_prompt, system_prompt = generate_gemma_prompt(task)
...
with open("/ijc/LABS/SOLE/DATA/tfm_CLG/attribute_association/PLAIN/gemma_results_1766.json", "w", encoding="utf-8") as f:
    json.dump(results, f, ensure_ascii=False, indent=4)
    
print("Results saved to gemma_results_1766.json")
...
with open("/ijc/LABS/SOLE/DATA/tfm_CLG/attribute_association/PLAIN/report_GEMMA_1766.txt", "w") as f:
    f.write("Attribute Classification Report\n")
    f.write(report)

print("Report saved to report_GEMMA_1766.txt")
