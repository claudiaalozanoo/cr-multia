...
with open("cr-multia/attribute_association/FEW_SHOT/gemma_results_1766.json", "w", encoding="utf-8") as f:
...
with open("cr-multia/attribute_association/FEW_SHOT/report_GEMMA_1766.txt", "w") as f:
