...
with open("/ijc/LABS/SOLE/DATA/tfm_CLG/attribute_association/PLAIN/llama3_results_520.json", "w", encoding="utf-8") as f:
    json.dump(results, f, ensure_ascii=False, indent=4)
    
print("Results saved to llama3_results_520.json")
...
with open("/ijc/LABS/SOLE/DATA/tfm_CLG/attribute_association/PLAIN/report_LLAMA3_520.txt", "w") as f:
