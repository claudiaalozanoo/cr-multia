...
with open("cr-multia/attribute_association/FEW_SHOT/qwen_results_118.json", "w", encoding="utf-8") as f:
...
with open("cr-multia/attribute_association/FEW_SHOT/report_QWEN_118.txt", "w") as f:
