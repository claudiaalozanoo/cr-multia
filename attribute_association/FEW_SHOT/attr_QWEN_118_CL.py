...
with open("/ijc/LABS/SOLE/DATA/tfm_CLG/attribute_association/PLAIN/qwen_results_118.json", "w", encoding="utf-8") as f:
    json.dump(results, f, ensure_ascii=False, indent=4)
    
print("Results saved to qwen_results_118.json")
...
with open("/ijc/LABS/SOLE/DATA/tfm_CLG/attribute_association/PLAIN/report_QWEN_118.txt", "w") as f:
    f.write("Attribute Classification Report\n")
    f.write(report)

print("Report saved to report_QWEN_118.txt")
