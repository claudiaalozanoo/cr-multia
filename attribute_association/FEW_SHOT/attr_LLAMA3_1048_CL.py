...
with open("cr-multia/attribute_association/FEW_SHOT/llama3_results_1048.json", "w", encoding="utf-8") as f:
...
with open("cr-multia/attribute_association/FEW_SHOT/report_LLAMA3_1048.txt", "w") as f:
