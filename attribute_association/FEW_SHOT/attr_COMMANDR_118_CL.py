...
with open("cr-multia/attribute_association/FEW_SHOT/commandr_results_118.json", "w", encoding="utf-8") as f:
...
with open("cr-multia/attribute_association/FEW_SHOT/report_COMMANDR_118.txt", "w") as f:
