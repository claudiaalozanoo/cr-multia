...
with open("cr-multia/attribute_association/FEW_SHOT/deepseek_results_1766.json", "w", encoding="utf-8") as f:
...
with open("cr-multia/attribute_association/FEW_SHOT/report_DEEPSEEK_1766.txt", "w") as f:
