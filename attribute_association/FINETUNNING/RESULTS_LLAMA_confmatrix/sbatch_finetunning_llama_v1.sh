...
#SBATCH --output=/ijc/LABS/SOLE/DATA/tfm_CLG/attribute_association/FINETUNNING/RESULTS_LLAMA_confmatrix/logs/llama_finetunning_%j.log 
...
python fine_tunning_LLAMA3_v1.py 
