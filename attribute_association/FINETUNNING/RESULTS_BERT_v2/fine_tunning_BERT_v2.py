...
training_args = TrainingArguments(
    output_dir="cr-multia/attribute_association/FINETUNNING/RESULTS_BERT_v2",
    eval_strategy="epoch",
...
# save adapter
OUT_DIR_LLM = "cr-multia/attribute_association/FINETUNNING/RESULTS_BERT_v2"
...
# save results
output_path = Path("cr-multia/attribute_association/FINETUNNING/RESULTS_BERT_v2")
