...
with open("/ijc/LABS/SOLE/DATA/tfm_CLG/medical_ner/HF/gpt_results_118.json", "w", encoding="utf-8") as f:
...
with open("/ijc/LABS/SOLE/DATA/tfm_CLG/medical_ner/HF/medical_ner_report_GPT_118.txt", "w") as f:
    f.write("Medical NER Classification Report\n")
    f.write(report)

print("Report saved to medical_ner_report_GPT_118.txt")
