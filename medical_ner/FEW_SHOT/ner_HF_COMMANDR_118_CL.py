...
with open("/ijc/LABS/SOLE/DATA/tfm_CLG/medical_ner/HF/commandr_results_118.json", "w", encoding="utf-8") as f:
...
with open("/ijc/LABS/SOLE/DATA/tfm_CLG/medical_ner/HF/medical_ner_report_COMMANDR_118.txt", "w") as f:
