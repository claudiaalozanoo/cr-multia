...
def process_ner(text):
    ...
    # clean markdown and keep json file
...
with open("cr-multia/medical_ner/FEW_SHOT/commandr_results_118.json", "w", encoding="utf-8") as f:
    json.dump(results, f, ensure_ascii=False, indent=4)
    
print("Results saved to commandr_results_118.json")


with open("cr-multia/medical_ner/FEW_SHOT/medical_ner_report_COMMANDR_118.txt", "w") as f:
    f.write("Medical NER Classification Report\n")
    f.write(report)

print("Report saved to medical_ner_report_COMMANDR_118.txt")
