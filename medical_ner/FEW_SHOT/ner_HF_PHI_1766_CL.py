...
with open("cr-multia/medical_ner/FEW_SHOT/phi_results_1766.json", "w", encoding="utf-8") as f:
...
with open("cr-multia/medical_ner/FEW_SHOT/medical_ner_report_PHI_1766.txt", "w") as f:
