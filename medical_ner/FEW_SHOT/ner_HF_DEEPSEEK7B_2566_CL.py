...
with open("cr-multia/medical_ner/FEW_SHOT/deepseek7b_results_2566.json", "w", encoding="utf-8") as f:
    json.dump(results, f, ensure_ascii=False, indent=4)
    
print("Results saved to deepseek7b_results_2566.json")


with open("cr-multia/medical_ner/FEW_SHOT/medical_ner_report_DEEPSEEK7B_2566.txt", "w") as f:
