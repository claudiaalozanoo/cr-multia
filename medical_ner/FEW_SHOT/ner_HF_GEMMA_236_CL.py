...
with open("cr-multia/medical_ner/FEW_SHOT/gemma_results_236.json", "w", encoding="utf-8") as f:
...
with open("cr-multia/medical_ner/FEW_SHOT/medical_ner_report_GEMMA_236.txt", "w") as f:
