...
with open("cr-multia/medical_ner/FEW_SHOT/deepseek7b_results_236.json", "w", encoding="utf-8") as f:
...
with open("cr-multia/medical_ner/FEW_SHOT/medical_ner_report_DEEPSEEK7B_236.txt", "w") as f:
