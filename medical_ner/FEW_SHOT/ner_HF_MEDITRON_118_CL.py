...
with open("cr-multia/medical_ner/FEW_SHOT/meditron_results_118.json", "w", encoding="utf-8") as f:
...
with open("cr-multia/medical_ner/FEW_SHOT/medical_ner_report_MEDITRON_118.txt", "w") as f:
