...
Analiza la siguiente nota clínica:
{text}
...
{prompt_format} [/INST]"""
    ...
    try:
        ...
        if match:
            ...
            print(f"DEBUG: No se detectó JSON")
...
with open("/ijc/LABS/SOLE/DATA/tfm_CLG/medical_ner/HF/meditron_results_118.json", "w", encoding="utf-8") as f:
    json.dump(results, f, ensure_ascii=False, indent=4)
    
print("Results saved to meditron_results_118.json")


# In[ ]:


with open("/ijc/LABS/SOLE/DATA/tfm_CLG/medical_ner/HF/medical_ner_report_MEDITRON_118.txt", "w") as f:
    f.write("Medical NER Classification Report\n")
    f.write(report)

print("Report saved to medical_ner_report_MEDITRON_118.txt")
