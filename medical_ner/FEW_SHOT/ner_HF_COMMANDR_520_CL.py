...
with open("cr-multia/medical_ner/FEW_SHOT/commandr_results_520.json", "w", encoding="utf-8") as f:
    json.dump(results, f, ensure_ascii=False, indent=4)
    
print("Results saved to commandr_results_520.json")


with open("cr-multia/medical_ner/FEW_SHOT/medical_ner_report_COMMANDR_520.txt", "w") as f:
