...
file_path = '/ijc/LABS/SOLE/DATA/tfm_CLG/medical_ner/data/subsample_520.json'
...
with open("/ijc/LABS/SOLE/DATA/tfm_CLG/medical_ner/HF/commandr_results_520.json", "w", encoding="utf-8") as f:
...
with open("/ijc/LABS/SOLE/DATA/tfm_CLG/medical_ner/HF/medical_ner_report_COMMANDR_520.txt", "w") as f:
    f.write("Medical NER Classification Report\n")
    f.write(report)

print("Report saved to medical_ner_report_COMMANDR_520.txt")
