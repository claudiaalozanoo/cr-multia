...
with open("cr-multia/medical_ner/FEW_SHOT/gemma_results_2566.json", "w", encoding="utf-8") as f:
...
with open("cr-multia/medical_ner/FEW_SHOT/medical_ner_report_GEMMA_2566.txt", "w") as f:
