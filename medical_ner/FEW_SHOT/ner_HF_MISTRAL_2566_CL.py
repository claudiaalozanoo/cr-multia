...
with open("cr-multia/medical_ner/FEW_SHOT/mistral_results_2566.json", "w", encoding="utf-8") as f:
...
with open("cr-multia/medical_ner/FEW_SHOT/medical_ner_report_MISTRAL_2566.txt", "w") as f:
