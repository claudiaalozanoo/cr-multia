...
with open("cr-multia/medical_ner/FEW_SHOT/mistral_results_520.json", "w", encoding="utf-8") as f:
...
with open("cr-multia/medical_ner/FEW_SHOT/medical_ner_report_MISTRAL_520.txt", "w") as f:
