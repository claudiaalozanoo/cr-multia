...
with open("cr-multia/medical_ner/FEW_SHOT/phi_results_2566.json", "w", encoding="utf-8") as f:
...
with open("cr-multia/medical_ner/FEW_SHOT/medical_ner_report_PHI_2566.txt", "w") as f:
