...
with open("/ijc/LABS/SOLE/DATA/tfm_CLG/medical_ner/HF/llama_results_2566.json", "w", encoding="utf-8") as f:
    json.dump(results, f, ensure_ascii=False, indent=4)
    
print("Results saved to llama_results_2566.json")


# In[ ]:


with open("/ijc/LABS/SOLE/DATA/tfm_CLG/medical_ner/HF/medical_ner_report_LLAMA3_2566.txt", "w") as f:
    f.write("Medical NER Classification Report\n")
    f.write(report)

print("Report saved to medical_ner_report_LLAMA3_2566.txt")
