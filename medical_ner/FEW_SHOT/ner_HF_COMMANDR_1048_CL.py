...
def process_ner(text):
    # user_prompt with output format
    prompt_format = """{
    "entities": [
    ...
    # clean marksown blocks and keep json file
...
with open("cr-multia/medical_ner/FEW_SHOT/commandr_results_1048.json", "w", encoding="utf-8") as f:
    json.dump(results, f, ensure_ascii=False, indent=4)
    
print("Results saved to commandr_results_1048.json")


with open("cr-multia/medical_ner/FEW_SHOT/medical_ner_report_COMMANDR_1048.txt", "w") as f:
