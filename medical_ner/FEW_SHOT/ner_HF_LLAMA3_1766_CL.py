...
with open("cr-multia/medical_ner/FEW_SHOT/llama_results_1766.json", "w", encoding="utf-8") as f:
...
with open("cr-multia/medical_ner/FEW_SHOT/medical_ner_report_LLAMA3_1766.txt", "w") as f:
